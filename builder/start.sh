...
python -m vllm.entrypoints.openai.api_server --model microsoft/Phi-3.5-mini-instruct --max-model-len 1024 --dtype=half --gpu-memory-utilization 0.85 --port 5001 --trust-remote-code --disable-log-requests
